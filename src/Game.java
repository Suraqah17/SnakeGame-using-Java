...
class Game extends JPanel {
    ...
    private static final Font FONT_M = new Font("Open Sans", Font.BOLD, 24); //SCORE
    private static final Font FONT_M_ITALIC = new Font("MV Boli", Font.ITALIC, 30);  //STARTING
    private static final Font FONT_L = new Font("MV Boli", Font.PLAIN, 84);  // GAME OVER
    private static final Font FONT_XL = new Font("MV Boli", Font.PLAIN, 150); //STARTING GAME
    private static final int WIDTH = 760;
    private static final int HEIGHT = 520;
    String un="";
    Connection con;
    // Constructor
    public Game(int highscore, String username, Connection con) {
        best=highscore;
        un=username;
        this.con=con;
        try {
        ...
        setFocusable(true);
        setBackground(new Color(13, 224, 255));
    ...
    void updatedb(int b) throws SQLException {
        String cmnd="UPDATE highscore SET highscore = "+best+" where username = \""+un+"\"";
